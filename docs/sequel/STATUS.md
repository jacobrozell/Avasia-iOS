...
## Critical path (playable end-to-end)

```
Housing → Courtyard → Portal → Library → Throne → Aylova → Northern March
...
| Item | Status |
|---|---|
| Quest/combat XP + level-up (Python thresholds) | ✅ |
| Level + Lv in game status strip | ✅ |
| SoC trophy unlock toasts | ✅ |
| Contextual quick actions (Attack, March, Advance…) | ✅ |
| Scout bypass on northern march | ✅ |
| Campaign-complete badge on SoC title | ✅ |
| E2E critical-path tests | ✅ `SoCCriticalPathTests` |
