    ...
    func handle(_ input: ParsedInput, _ state: inout GameState) -> TurnResult {
        if state.escortActive {
            return TurnResult([
                ...
                .speech("It's time for you to go. You're going to join the Academy. Please, son, don't forget us."),
                .body("You remember Vashirr becoming king when you were thirteen. Your graduation. Your work as a teacher to the new young Mages."),
                .blank,
